...
ngx_int_t
ngx_http_core_post_read_phase(ngx_http_request_t *r, ngx_http_phase_handler_t *ph)
{
    return ngx_http_core_generic_phase(r, ph);
}


ngx_int_t
ngx_http_core_preaccess_phase(ngx_http_request_t *r, ngx_http_phase_handler_t *ph)
{
    return ngx_http_core_generic_phase(r, ph);
}
